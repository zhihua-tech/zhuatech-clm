...
@Entity @Table(name="clm_contract_review") public class ContractReview extends BaseEntity {
    ...
    @ManyToOne(optional=false,fetch=FetchType.LAZY) private ContractPortfolio contractPortfolio; @Column(nullable=false) private int plannedQty; @Column(nullable=false) private int completedQty; @Column(nullable=false) private int defectQty;
