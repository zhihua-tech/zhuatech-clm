...
@Entity @Table(name="clm_clause_template") public class ClauseTemplate extends BaseEntity {
    ...
    protected ClauseTemplate(){} /**
                                  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                  */
public ClauseTemplate(String code,String name,ContractPortfolio contractPortfolio,Status status,int oee){this.code=code;this.name=name;this.contractPortfolio=contractPortfolio;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
